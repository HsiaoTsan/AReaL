...
def get_boba_math_dataset(path, tokenizer, split):
...
def main(args):
    ...
    train_dataset = get_boba_math_dataset(
        path=config.train_dataset.path, tokenizer=tokenizer, split="train"
    )
    valid_dataset = get_boba_math_dataset(
        path=config.valid_dataset.path, tokenizer=tokenizer, split="test"
    )
    ...
    # Initialize inference engine with vLLM
